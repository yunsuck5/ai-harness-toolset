...
Repo 내부 human-facing prose의 binding 언어 경계는 root `CLAUDE.md` / `AGENTS.md` shared body의 *Human-facing repo prose* 규율을 따릅니다. 이 기여 안내서는 그 경계를 소비하며 별도 언어 정책을 재정의하지 않습니다.
