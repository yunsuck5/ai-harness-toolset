...
- `<project-root>/brief/BRIEF.md` is the **durable project restore file** (BF Level 3). A new collaborator or a new AI agent reads it first to understand the project.
