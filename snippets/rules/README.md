...
- [rule-conflict-and-revision-routing.md](rule-conflict-and-revision-routing.md) — genuine active-rule conflicts: keep the applicable rule binding, disclose the exact blocked scope, and ask the user to rescope, hold or drop the work, or start owner-local revision without granting an exception.
