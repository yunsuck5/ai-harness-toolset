...
- [rule-conflict-and-revision-routing.md](rule-conflict-and-revision-routing.md) — genuine active-rule conflicts: preserve current binding state, contain dependent work, disclose blocked scope, and route compliant rescope or owner-local revision without granting an exception.
