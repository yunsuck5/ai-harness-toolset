...
# ---------------------------------------------------------------------------
$termReserveBoundCandidates = @('consultation', 'blind-advisory', 'subagent-work-orchestration')
