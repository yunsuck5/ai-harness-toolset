...
Current status (→ per-domain spec/backlog files; question→read-first routing → `docs/README.md`), execution policy (→ `docs/policies/`), and superseded/historical decisions (→ git history).
