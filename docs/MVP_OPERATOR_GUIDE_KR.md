...
- `<project-root>/log/brief/BRIEF.md` (`docs/BRIEF_CONTRACT.md`, BF Level 3 durable restore — `log/` 아래 operator-local runtime state).
- `log/chatlog/current/resume.md` / `summary.md` (`docs/CHATLOG_CONTRACT.md`, BF Level 1/2 artifact).
...
- GJMNet clean adoption 은 post-MVP foundation 항목 (Brief system / BF Level 3 / packaging) 이 ready 된 뒤 별도 scoped 승인을 받아 진행한다 (`docs/roadmap/POST_MVP_PLAN.md` §7).
