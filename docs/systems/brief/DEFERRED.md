...
| BR-D-02 | BF Level 3 — restore-offer source-side automation | depends on BR-D-01 deterministic writer | BR-D-01 design approved | `docs/decisions/POST_MVP_PLAN.md` §5 |
