...
| IU-14 | Install/update lifecycle LTS readiness (subsystem closeout) | `main` HEAD `69ef433` (Pester 440/440) | the subsystem entered LTS maintenance; **subsystem-only** decision (NOT whole-project LTS, NOT Phase 4b complete, NOT by itself a primary-machine apply claim) | git history; `DEFERRED.md` IU-D-05 (whole-project Step 6 remains open) |
...
- Not a whole-project LTS declaration and not an entire Post-MVP / whole-project closeout (the roadmap Step 6 for the *project* is broader — `DEFERRED.md` IU-D-05; this closes the install/update lifecycle subsystem only).
