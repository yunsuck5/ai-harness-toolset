...
(Aggregate digest reproducibility closeout is ledgered as IU-11. "Brief location reconciliation" is a brief-domain closeout — current spec-of-record `docs/brief/brief_spec.md`; detail in git history.)
