...
- future work: `review_backlog.md`(RV-B-01/03/04/05 이주 + RV-B-09~12 신설 + RV-B-13 이관[retired skills 서브시스템 Batch 4]; next ID: RV-B-14)가 open 항목·수용된 잔여 위험·idea-only 항목을 보유한다.
