...
- review: RV-B-01 (Review 2-pass/profile), RV-B-02 (`timeoutSeconds` enforcement debt), RV-B-03 (review result wrapper/fence hygiene), RV-B-04 (no-exec/no-write reviewer contract) → `docs/systems/review/BACKLOG.md`.
