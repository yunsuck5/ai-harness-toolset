...
| **F — Batch 3** | remove non-current snippet sections + BF-lv3 non-claim | **= skill plan §8 Batch 3** (authority there); **Landed** (`docs/systems/skills/STATUS.md` SK-05 — `## Brief` + another non-current section deleted, the no-auto-mirror *Forbidden* bullet removed, snippet 10 → 8 H2); ran **separately** from Track D (SK-03) |
...
5. **Whether Track D absorbs Track F (Batch 3)** or they run separately — **Resolved (Track D): ran separately** — Track D landed (`docs/systems/skills/STATUS.md` SK-03) without absorbing Track F; Batch 3 (non-current-section removal) **has since landed separately** (`docs/systems/skills/STATUS.md` SK-05; §14 Track F).
