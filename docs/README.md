...
| `docs/contracts/` | artifact/protocol contracts (`global-invocation/`; the former `review/` and `evidence/` contracts are absorbed into `docs/review/review_spec.md`) | when producing/validating that artifact |
