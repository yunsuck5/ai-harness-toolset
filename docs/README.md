...
| `docs/systems/` | remaining per-subsystem boards (now `skills/` only — STATUS + plan); the former install-update system docs migrated to `docs/install-update/` | when checking a subsystem's state |
