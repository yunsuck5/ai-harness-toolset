...
Candidate vocabulary only — each entry names its owner (a domain or a rule candidate), facet, close condition, not-this boundary, and promotion target; nothing here is finalized. This section *classifies* these terms; it does **not** rewrite their existing repo usage — that is each owner's work.
