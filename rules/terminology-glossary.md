...
- (none open — the formerly-pending `concrete-path value vs normative boundary` term **closed** in the `snippets/rules/` concrete-path audit; see *Term ownership and close conditions*.)
