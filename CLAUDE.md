...
Always-on for this repo (its canonical scripts are all `.ps1`). The repo-only file / output discipline is **collected in the repo-only rules tier `rules/powershell-and-file-encoding.md`** (authority: `docs/policies/POWERSHELL_POLICY.md` + `docs/policies/CLI_ENVIRONMENT_ASSUMPTIONS.md` Tier 1). In short:
